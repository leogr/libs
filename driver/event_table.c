...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SYSCALL_SETGID_E] =
                {"setgid", EC_USER | EC_SYSCALL, EF_MODIFIES_STATE | EF_TMP_CONVERTER_MANAGED, 1, {{"gid", PT_GID, PF_DEC}}},
        [PPME_SYSCALL_SETGID_X] =
                {"setgid", EC_USER | EC_SYSCALL, EF_MODIFIES_STATE | EF_TMP_CONVERTER_MANAGED, 2, {{"res", PT_ERRNO, PF_DEC}, {"gid", PT_GID, PF_DEC}}},
