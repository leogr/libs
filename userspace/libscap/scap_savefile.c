...
int32_t scap_read_init(scap_t *handle, gzFile f)
{
	...
	//
	// NOTE: can't require a user list block or interface list block any longer--with the
	//       introduction of source plugins, it is legitimate to have trace files that
	//       don't contain user list and interface list blocks.
	//
